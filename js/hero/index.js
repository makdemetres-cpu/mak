...
import { Vector3 } from '../vendor/three.slim.js?v=260827b';
import { createRig, detectTier, hasWebGL, makeResizer } from './scene.js?v=260827b';
import { buildVilla, makeMaterials } from './villa.js?v=260827b';
import { buildPhotos } from './photos.js?v=260827b';
import { CHAPTERS, chapterAt, clamp01, doorAngle, evaluate } from './path.js?v=260827b';
