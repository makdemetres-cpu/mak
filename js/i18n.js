...
(function () {
  ...
  var STRINGS = {
    el: {
      ...
      "reviews.title": "Τι λένε <em class=\"accent-italic\">οι πελάτες μας</em>",
      "reviews.summaryRating": "{rating} στα 5",
      "reviews.summaryCount": "από {total} κριτικές στο Google",
      "reviews.leave": "Αφήστε κριτική",
      "reviews.sourceGoogle": "Κριτική στο Google",
      "reviews.sourceSite": "Μέσω του ιστότοπου",
      "reviews.starsLabel": "{n} στα 5 αστέρια",
      "reviews.stars5": "5 στα 5 αστέρια",
      ...
      "review.name": "Το όνομά σας",
      "review.namePh": "π.χ. Μαρία Π.",
      "review.nameHint": "Ό,τι γράψετε εδώ θα φαίνεται δημόσια — μπορείτε να βάλετε μόνο το μικρό σας όνομα.",
      "review.rating": "Βαθμολογία",
      "review.text": "Η κριτική σας",
      "review.textPh": "Πείτε μας για την εμπειρία σας στο Vet Care.",
      "review.email": "Email",
      ...
      "review.mailNote": "Σε αυτή την προεπισκόπηση η κριτική δεν αποθηκεύεται στον διακομιστή. Μόλις πατήσετε αποστολή, θα σας δώσουμε το κείμενο έτοιμο για να το στείλετε ή να το αφήσετε στο Google.",
      "review.status.copy": "Η κριτική σας είναι έτοιμη παρακάτω. Αντιγράψτε τη και στείλτε τη, ή αφήστε τη απευθείας στο Google.",
      "review.fallback.intro": "Σε αυτή την προεπισκόπηση δεν μπορούμε να αποθηκεύσουμε την κριτική στον διακομιστή. Διαλέξτε έναν από τους παρακάτω τρόπους — και οι τρεις λειτουργούν.",
      "review.fallback.textLabel": "Το κείμενο της κριτικής σας, έτοιμο για αντιγραφή",
      "review.fallback.copy": "Αντιγραφή",
      "review.fallback.copied": "Αντιγράφηκε. Επικολλήστε τη όπου θέλετε να τη στείλετε.",
      "review.fallback.selectManually": "Το κείμενο είναι επιλεγμένο — αντιγράψτε το με Ctrl+C (ή Cmd+C).",
      "review.fallback.google": "Αφήστε την στο Google",
      "review.fallback.email": "Email",
      "review.cancel": "Άκυρο",
      "review.close": "Κλείσιμο",
      "review.status.sending": "Γίνεται αποστολή…",
      "review.status.ok": "Ευχαριστούμε! Η κριτική σας στάλθηκε και θα δημοσιευτεί μόλις την ελέγξει το ιατρείο.",
      "review.status.err": "Κάτι πήγε στραβά με την αποστολή. Δοκιμάστε ξανά σε λίγο.",
      "review.status.offline": "Η αποστολή κριτικών δεν είναι διαθέσιμη αυτή τη στιγμή. Στείλτε μας την κριτική σας στο info@vet-care.gr ή αφήστε την στο Google.",
      "review.err.author": "Γράψτε το όνομα που θέλετε να εμφανίζεται.",
      "review.err.rating": "Επιλέξτε βαθμολογία από 1 έως 5 αστέρια.",
      "review.err.text": "Γράψτε λίγα λόγια για την εμπειρία σας (τουλάχιστον 10 χαρακτήρες).",
      ...
      "booking.datePlaceholder": "Επιλέξτε ημερομηνία",
      ...
      "contact.social.fb": "Το Vet Care στο Facebook (ανοίγει σε νέα καρτέλα)",
      "day.mon": "Δευτέρα",
      "day.tue": "Τρίτη",
      "day.wed": "Τετάρτη",
      "day.thu": "Πέμπτη",
    ...
    en: {
      ...
      "reviews.title": "What <em class=\"accent-italic\">our clients say</em>",
      "reviews.summaryRating": "{rating} out of 5",
      "reviews.summaryCount": "from {total} Google reviews",
      "reviews.leave": "Leave a review",
      "reviews.sourceGoogle": "Google review",
      "reviews.sourceSite": "Left on this website",
      "reviews.starsLabel": "{n} out of 5 stars",
      "reviews.stars5": "5 out of 5 stars",
      ...
      "review.namePh": "e.g. Maria P.",
      "review.nameHint": "Whatever you type here is shown publicly — a first name alone is fine.",
      "review.rating": "Rating",
      "review.text": "Your review",
      "review.textPh": "Tell us about your experience at Vet Care.",
      "review.email": "Email",
      ...
      "review.mailNote": "This preview does not save the review to a server. Once you press send, we hand you the text ready to send on, or to leave straight on Google.",
      "review.status.copy": "Your review is ready below. Copy it and send it, or leave it straight on Google.",
      "review.fallback.intro": "This preview cannot save the review to a server. Pick whichever of these suits you — all three work.",
      "review.fallback.textLabel": "The text of your review, ready to copy",
      "review.fallback.copy": "Copy",
      "review.fallback.copied": "Copied. Paste it wherever you would like to send it.",
      "review.fallback.selectManually": "The text is selected — copy it with Ctrl+C (or Cmd+C).",
      "review.fallback.google": "Leave it on Google",
      "review.fallback.email": "Email",
      "review.cancel": "Cancel",
      "review.close": "Close",
      "review.status.sending": "Sending…",
      "review.status.ok": "Thank you! Your review has been sent and will appear once the clinic has checked it.",
      "review.status.err": "Something went wrong while sending. Please try again shortly.",
      "review.status.offline": "Leaving a review is not available right now. Send it to info@vet-care.gr instead, or leave it on Google.",
      "review.err.author": "Please enter the name you would like shown.",
      "review.err.rating": "Please choose a rating from 1 to 5 stars.",
      "review.err.text": "Please write a few words about your experience (at least 10 characters).",
      ...
      "booking.datePlaceholder": "Choose a date",
      ...
      "contact.social.fb": "Vet Care on Facebook (opens in a new tab)",
      "day.mon": "Monday",
      "day.tue": "Tuesday",
      "day.wed": "Wednesday",
      "day.thu": "Thursday",
