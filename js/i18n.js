...
(function () {
  ...
  var STRINGS = {
    el: {
      ...
      "reviews.lede": "Οι πέντε πιο πρόσφατες κριτικές με 4 και 5 αστέρια. Ανανεώνονται μόνες τους κάθε φορά που κάποιος αφήνει καινούργια.",
      "reviews.summaryRating": "{rating} στα 5",
      "reviews.summaryCount": "από {total} κριτικές στο Google",
      "reviews.loading": "Φόρτωση κριτικών…",
      "reviews.empty": "Δεν υπάρχουν ακόμη κριτικές για προβολή εδώ. Δείτε τις κριτικές μας στο Google ή αφήστε τη δική σας.",
      "reviews.error": "Οι κριτικές δεν φορτώθηκαν αυτή τη στιγμή. Δοκιμάστε τις στο Google.",
      "reviews.seeAll": "Δείτε όλες τις κριτικές στο Google",
    ...
    en: {
      ...
      "reviews.lede": "The five most recent 4- and 5-star reviews. They refresh on their own whenever someone leaves a new one.",
      "reviews.summaryRating": "{rating} out of 5",
      "reviews.summaryCount": "from {total} Google reviews",
      "reviews.loading": "Loading reviews…",
      "reviews.empty": "There are no reviews to show here yet. See our reviews on Google, or leave your own.",
      "reviews.error": "The reviews could not be loaded just now. You can read them on Google instead.",
