...
(function () {
  ...
  var STRINGS = {
    el: {
      ...
      "review.submitMail": "Αποστολή με email",
      "review.mailNote": "Η κριτική στέλνεται μέσω του δικού σας προγράμματος email — θα ανοίξει συμπληρωμένη και θα χρειαστεί να πατήσετε «Αποστολή» εκεί.",
      "review.status.mailed": "Άνοιξε το πρόγραμμα email σας με την κριτική συμπληρωμένη. Πατήστε «Αποστολή» εκεί για να μας τη στείλετε.",
      "review.cancel": "Άκυρο",
    ...
    en: {
      ...
      "review.submitMail": "Send by email",
      "review.mailNote": "The review is sent through your own email app — it opens pre-filled, and you press Send there.",
      "review.status.mailed": "Your email app has opened with the review filled in. Press Send there to get it to us.",
